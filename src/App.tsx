...
function HomeView({ onEnable }: { onEnable: () => void }) {
  ...
  return (
    <>
          ...
          >
            ...
            >
              ...
              <div className="text-center">
                ...
                <div className="text-xs text-white/35 mt-2">15 题 · 约 3 分钟</div>
              </div>
            </motion.button>
            ...
            >
              ...
              <div className="text-center">
                ...
                <div className="text-xs text-white/35 mt-2">36 题 · 约 7 分钟</div>
              </div>
            </motion.button>
          </motion.div>
        </motion.div>
      ...
      <div className="fixed bottom-[26vh] sm:bottom-[38vh] right-[8%] sm:right-[12%] z-20">
